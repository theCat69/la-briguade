...
> [critic output from Step 3]
>
> Proceed with the implementation pipeline (coder → sidekick-reviewer → librarian), and run `security-reviewer` only if the user explicitly requests a security review/audit.
