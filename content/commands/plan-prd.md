...
3. If ambiguity is **≥ 20%**, ask exactly one highest-impact clarifying question. Wait for the answer.
4. After each answer, re-score and report updated scores. If ambiguity remains ≥ 20%, continue with the next single clarifying question.
...
8. Never ask more than one question per round.
...
After all domain research completes, present the result in this format:

```markdown
## 📦 Library Comparison

### [Domain 1]
| Library | Version | Strengths | Weaknesses | Recommended? |
|---|---|---|---|---|
...
...
>
> **Library choices:**
> [library comparison from Step 4]
...
- **Change library choices** — re-research libraries (go back to Step 4)
